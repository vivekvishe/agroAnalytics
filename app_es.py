...
def check_password():
    ...
    with col2:
        st.text_input("Usuario", key="username", placeholder="Ingrese usuario")
        st.text_input("Contraseña", type="password", key="password", placeholder="Ingrese contraseña")
    ...
    if not clients_df.empty:
        ...
        with col_opp1:
            ...
            if not potential_buyers_df.empty:
                ...
                display_buyers.columns = ['Prospect Name', 'Connections to Clients', 'Volume', 'Transacciones', 'Commission Opp.']
        ...
        with col_opp2:
            ...
            if not potential_sellers_df.empty:
                ...
                display_sellers = potential_sellers_df[['prospect_name', 'num_connections_to_clients', 
                                                        'total_volume', 'total_transactions', 
                                                        'commission_opportunity']].copy()
                display_sellers.columns = ['Prospect Name', 'Connections to Clients', 'Volume', 'Transacciones', 'Commission Opp.']
